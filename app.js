...
btnVal.forEach( (v , i) => {
    ...
    btnVal[i].addEventListener( 'click',(event)=>{
        ...
        !/^([\da-z_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/.exec(email) ? inputVal[i].focus() : alert("Esta es solamente una página de practicas de Ramon Estol");
